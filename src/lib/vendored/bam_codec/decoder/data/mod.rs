...
use noodles::sam::alignment::{record::data::field::Tag, record_buf::Data};
...
mod tests {
    ...
    fn test_read_data() -> Result<(), DecodeError> {
        ...
        let expected = [(Tag::ALIGNMENT_HIT_COUNT, Value::UInt8(1))].into_iter().collect();
        ...
        let expected =
            [(Tag::ALIGNMENT_HIT_COUNT, Value::UInt8(1)), (Tag::READ_GROUP, Value::from("rg0"))]
                .into_iter()
                .collect();
