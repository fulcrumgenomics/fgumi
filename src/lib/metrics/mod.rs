...
/// # Example
/// ```
/// use fgumi_lib::metrics::format_float;
...
///
/// ```ignore
/// use fgumi_lib::metrics::ProcessingMetrics;
///
/// fn log_summary(metrics: &impl ProcessingMetrics) {
///     let efficiency = if metrics.total_input() > 0 {
///         metrics.total_output() as f64 / metrics.total_input() as f64 * 100.0
///     } else {
///         0.0
///     };
...
mod tests {
    ...
    fn test_processing_metrics_generic_usage() {
        // Test that ProcessingMetrics can be used generically
