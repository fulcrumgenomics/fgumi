...
pub const GROUP_MIN_MAPQ: u8 = 1;
/// Default: disallow fully-unmapped templates in grouping.
pub const GROUP_ALLOW_UNMAPPED: bool = false;
...
/// Default minimum number of raw reads to support a consensus base/read.
pub const FILTER_MIN_READS: usize = 1;
/// Default minimum base quality score (after masking).
pub const FILTER_MIN_BASE_QUALITY: u8 = 2;
/// Default maximum per-read error rate.
pub const FILTER_MAX_READ_ERROR_RATE: f64 = 0.025;
/// Default maximum per-base error rate.
pub const FILTER_MAX_BASE_ERROR_RATE: f64 = 0.1;
