...
#[test]
#[ignore = "TODO: debug resume-from-sort producing 0 output records"]
...
/// Sort the input first, then runall --start-from group.
/// Verifies output matches a full extract-to-end run.
#[test]
#[ignore = "TODO: debug resume-from-group producing 0 output records"]
fn test_runall_group_to_end() {
    ...
    partial_args.extend_from_slice(&["--stop-after", "sort", "--threads", "4"]);
    run_fgumi(&partial_args);
