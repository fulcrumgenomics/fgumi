...
#[test]
#[ignore = "plan 2c-2: pipeline does not yet implement --start-from extract (used to \
            produce the reference output) or --stop-after zipper."]
...
#[test]
#[ignore = "plan 2c-2: pipeline does not yet implement --start-from extract (used to \
            produce the reference output) or --stop-after group."]
...
#[test]
#[ignore = "plan 2c-2: pipeline does not yet implement --start-from extract or \
            --stop-after sort."]
...
#[ignore = "v1 orchestrator race; retires when v1 is deleted (plan 3)"]
#[test]
