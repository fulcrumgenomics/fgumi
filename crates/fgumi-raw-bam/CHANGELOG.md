...
- Capture overlapping selected aux tags independently ([#851](https://github.com/fulcrumgenomics/fgumi/pull/851))
- Trim read-through on dovetail FR pairs in the MC-tag path ([#853](https://github.com/fulcrumgenomics/fgumi/pull/853))
...
- Remove dead SamRecordClipper, port its tests to RawRecordClipper ([#854](https://github.com/fulcrumgenomics/fgumi/pull/854))
...
- Stop MC CIGAR parsing from panicking and wrapping ([#640](https://github.com/fulcrumgenomics/fgumi/pull/640))
...
- Pin the aux-tag walker against every BAM type code ([#618](https://github.com/fulcrumgenomics/fgumi/pull/618))
