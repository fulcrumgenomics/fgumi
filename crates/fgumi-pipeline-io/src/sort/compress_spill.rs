...
//! worker** (via [`fgumi_sort::write_sorted_chunk`], retiring the private
...
/// Dispatch a sorted [`MemoryChunkErased`] to [`fgumi_sort::write_sorted_chunk`]
/// for the concrete key variant.
fn write_chunk(
